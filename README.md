...
- [`docs/TOOLCHAIN_MIGRATION_BLUEPRINT_20260318.md`](docs/TOOLCHAIN_MIGRATION_BLUEPRINT_20260318.md)
- [`docs/CROSS_PLATFORM_SETUP_GUIDE_20260318.md`](docs/CROSS_PLATFORM_SETUP_GUIDE_20260318.md)
- [`docs/MACOS_BOOTSTRAP_GUIDE_20260318.md`](docs/MACOS_BOOTSTRAP_GUIDE_20260318.md)
...
- Keil 工程仍保留兼容性
- Windows/macOS 已有统一命令入口
- GCC/CMake 固件构建已可运行，并可输出 `build-summary` 与 `map` 摘要
- `host_sim` 已具备 Modbus、日志回放、保护策略回归入口
- 模板生成与项目族参数骨架已具备基础能力
