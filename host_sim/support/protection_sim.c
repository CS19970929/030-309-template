                        ...
                        AppSimOutputSnapshot *output)
{
    ...
    output->charge_mos_off = (output->fault_first &
                              (PROTECTION_FAULT_CELL_OVP | PROTECTION_FAULT_CHG_OCP |
                               PROTECTION_FAULT_CHG_OTP | PROTECTION_FAULT_MOS_OTP)) != 0U;
    output->discharge_mos_off = (output->fault_first &
                                 (PROTECTION_FAULT_CELL_UVP | PROTECTION_FAULT_DSG_OCP |
                                  PROTECTION_FAULT_DSG_UTP | PROTECTION_FAULT_MOS_OTP)) != 0U;
}
