...
#define FLASH_ADDR_TEST_BMS_PARAM       0x0800E000
// #define FLASH_ADDR_LOG_FLASH_PAGE0       (FLASH_ADDR_TEST_BMS_PARAM + 0x400)
// #define FLASH_ADDR_LOG_FLASH_PAGE1       (FLASH_ADDR_TEST_BMS_PARAM + 0x400 + 0x400)
// #define FLASH_ADDR_LOG_BMS_LOG_POINT     (FLASH_ADDR_TEST_BMS_PARAM + 0x400 + 0x400 + 0x400)
#define FLASH_ADDR_LOG_FLASH_PAGE0       (0x0800E400)
#define FLASH_ADDR_LOG_FLASH_PAGE1       (0x0800E800)
#define FLASH_ADDR_LOG_BMS_LOG_POINT     (0x0800EC00)
