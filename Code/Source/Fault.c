...
void App_CellOvp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag1)
	{
		...
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16VcellOvp_First; // DELAYB10MS_500MS¸ÄÎªfilter
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VcellOvp_Filter;				   // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VcellOvp_Filter;				   // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
...
void App_CellOvp_ThirdCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag1)
	{
		...
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16VcellOvp_Rcv; // DELAYB10MS_500MS¸ÄÎªfilter
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VcellOvp_Filter;				  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VcellOvp_Filter;				  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;												  // ÕýÂß¼­
...
void App_CellUvp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag1)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VcellUvp_Filter;				   // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VcellUvp_Filter;				   // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
...
void App_BatOvp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag2)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VbusOvp_Filter;				  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VbusOvp_Filter;				  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;												  // ÕýÂß¼­
...
void App_BatUvp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag2)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VbusUvp_Filter;				  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VbusUvp_Filter;				  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 0;												  // ¸ºÂß¼­
...
void App_IchgOcp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16OPValB = g_tParam.protect.u16IchgOcp_Second; // ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16IchgOcp_First;	// Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16IchgOcp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16IchgOcp_Filter + CurOverFaultDelay; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï-->ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.u8FlagLogic = 1;													  // ÕýÂß¼­
...
void App_IchgOcp_ThirdCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16ChkVal = g_stCellInfoReport.u16Ichg;
		t_sPubOPUPChk.u16OPValB = g_tParam.protect.u16IchgOcp_Third; // ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16IchgOcp_Rcv;   // Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16IchgOcp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16IchgOcp_Filter + CurOverFaultDelay; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï-->ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.u8FlagLogic = 1;													  // ÕýÂß¼­
...
void App_IdischgOcp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16OPValB = g_tParam.protect.u16IdsgOcp_Second; // ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16IdsgOcp_First;	// Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16IdsgOcp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16IdsgOcp_Filter + CurOverFaultDelay; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï-->ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.u8FlagLogic = 1;													  // ÕýÂß¼­
...
void App_IdischgOcp_ThirdCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag3)
	{
		...
		t_sPubOPUPChk.u16ChkVal = g_stCellInfoReport.u16IDischg;
		t_sPubOPUPChk.u16OPValB = g_tParam.protect.u16IdsgOcp_Third; // ¹ýÁ÷ÅÐ¶Ï
		t_sPubOPUPChk.u16OPValS = g_tParam.protect.u16IdsgOcp_Rcv;   // Ã»ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16IdsgOcp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16IdsgOcp_Filter + CurOverFaultDelay; // Ã»ÓÐ»Ö¸´ÅÐ¶Ï-->ÓÐ»Ö¸´ÅÐ¶Ï
		t_sPubOPUPChk.u8FlagLogic = 1;													  // ÕýÂß¼­
...
void App_CellChgOtp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16TChgOTp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16TChgOTp_Filter;					  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;													  // ÕýÂß¼­
...
void App_CellDisChgOtp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16TdischgOTp_Filter;					 // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16TdischgOTp_Filter;					 // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;														 // ÕýÂß¼­
...
void App_MosOtp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16TmosOTp_Filter;				   // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16TmosOTp_Filter;				   // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;												   // ÕýÂß¼­
...
void App_CellChgUtp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16TchgUTp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16TchgUTp_Filter;					  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 0;													  // ¸ºÂß¼­
...
void App_CellDischgUtp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16TdischgUTp_Filter;					 // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16TdischgUTp_Filter;					 // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 0;														 // ¸ºÂß¼­
...
void App_CellSocUp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag4)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16SocUp_Filter;					  // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16SocUp_Filter;					  // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 0;												  // ¸ºÂß¼­
...
void App_VdeltaOp_SecondCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VdeltaOvp_Filter;						 // ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = g_tParam.protect.u16VdeltaOvp_Filter;						 // ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
...
void App_VdeltaOp_ThirdCheck(void)
{
	...
	if (1 == g_st_SysTimeFlag.bits.b1Sys10msFlag5)
	{
		...
		t_sPubOPUPChk.i16ChkCnt = &s_i16TimeCnt;
		t_sPubOPUPChk.u16TimeCntB = g_tParam.protect.u16VdeltaOvp_Filter;						// ¹ÊÕÏÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u16TimeCntS = (g_tParam.protect.u16VdeltaOvp_Filter + 200);				// ¹ÊÕÏ»Ö¸´ÅÐ¶ÏÊ±¼ä500ms
		t_sPubOPUPChk.u8FlagLogic = 1;														// ¸ºÂß¼­
