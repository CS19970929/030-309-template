...
//��Ԫ��
#ifdef TERNARYLI
#define E2P_PROTECT_DEFAULT_PRT	{/*���ڹ�ѹ*/4000,	4100,	4200,	4100,	100,\
								 /*���ڵ�ѹ*/3000,	2900,	2800,	3000,	100,\
								 /*��ѹ��ѹ*/400*SNum, 410*SNum, 420*SNum, 410*SNum, 100,\
								 /*��ѹ��ѹ*/300*SNum, 290*SNum, 280*SNum, 300*SNum, 100,\
		        				 /*������*/45,	45,		45,		10,	200,\
		        				 /*�ŵ����*/450,	450,	600,	10,	400,\
								 /*������*/900,	900,	900,	850,	200,\
								 /*������*/400,	400,	400,	450,	200,\
								 /*�ŵ����*/1150,	1150,	1150,	1100,	200,\
								 /*�ŵ����*/200,	200,	200,	250,	200,\
		        				 /*��������*/1200,	1200,	1350,	1150,	100,\
...
#define E2P_PROTECT_DEFAULT_PRT	{/*���ڹ�ѹ*/3550,	3650,	3750,	3650,	100,\
								 /*���ڵ�ѹ*/2700,	2600,	2500,	2600,	100,\
								 /*��ѹ��ѹ*/355*SNum, 360*SNum,	365*SNum, 360*SNum, 100,\
								 /*��ѹ��ѹ*/270*SNum, 260*SNum,	250*SNum, 260*SNum, 100,\
		        				 /*������*/CURR_1C*4/5, 	CURR_1C,	CURR_1C,	CURR_1C / 2,	300,\
		        				 /*�ŵ����*/CURR_5C*4/5,	CURR_5C,	CURR_5C,	CURR_5C / 2,	30,\
								 /*������*/900,	950,	1050,	950,	100,\
								 /*������*/430,	400,	CHG_LOWTEMP_PARAM,	400,	100,\
								 /*�ŵ����*/900,	950,	1050,	950,	100,\
								 /*�ŵ����*/300,	250,	200,	300,	100,\
		        				 /*��������*/1200,	1250,	1350,	1200,	100,\
		        				 /*ѹ�����*/1000,	1000,	1000,	900,	100,\
		        				 /*��������*/3,		2,		1,		2,		100}
...
// 								  /*��ѹ��ѹ*/355*SNum, 360*SNum,	365*SNum, 360*SNum, 100,\
// 								 /*��ѹ��ѹ*/270*SNum, 260*SNum,	250*SNum, 260*SNum, 100,\
// 		        				 /*������*/1300,	1300,	1500,	1300,	300,\
// 		        				 /*�ŵ����*/7000,	7500,	8000,	7000,	30,\
// 								 /*������*/900,	950,	1050,	950,	100,\
// 								 /*������*/430,	400,	CHG_LOWTEMP_PARAM,	400,	100,\
// 								 /*�ŵ����*/900,	950,	1050,	950,	100,\
// 								 /*�ŵ����*/300,	250,	200,	300,	100,\
...
// 		        				 /*��������*/3,		2,		1,		2,		100}
#define E2P_PROTECT_DEFAULT_PRT	{/*���ڹ�ѹ*/4000,	4100,	4200,	4100,	100,\
								 /*���ڵ�ѹ*/2700,	2600,	2500,	2700,	100,\
								  /*��ѹ��ѹ*/355*SNum, 360*SNum,	365*SNum, 360*SNum, 100,\
								 /*��ѹ��ѹ*/270*SNum, 260*SNum,	250*SNum, 260*SNum, 100,\
		        				 /*������*/1450,	1500,	1550,	1500,	300,\
		        				 /*�ŵ����*/7000,	7500,	8000,	7500,	30,\
								 /*������*/900,	950,	1050,	950,	100,\
								 /*������*/430,	400,	CHG_LOWTEMP_PARAM,	400,	100,\
								 /*�ŵ����*/900,	950,	1050,	950,	100,\
								 /*�ŵ����*/300,	250,	200,	300,	100,\
...
#define E2P_PROTECT_DEFAULT_PRT	{/*���ڹ�ѹ*/3550,	3650,	3750,	3650,	100,\
								 /*���ڵ�ѹ*/2700,	2600,	2500,	2600,	100,\
								  /*��ѹ��ѹ*/355*SNum, 360*SNum,	365*SNum, 360*SNum, 100,\
								 /*��ѹ��ѹ*/270*SNum, 260*SNum,	250*SNum, 260*SNum, 100,\
		        				 /*������*/1500,	2000,	2000,	1500,	300,\
		        				 /*�ŵ����*/8000,	9000,	9000,	8000,	30,\
								 /*������*/900,	950,	1050,	950,	100,\
								 /*������*/430,	400,	CHG_LOWTEMP_PARAM,	400,	100,\
								 /*�ŵ����*/900,	950,	1050,	950,	100,\
								 /*�ŵ����*/300,	250,	200,	300,	100,\
