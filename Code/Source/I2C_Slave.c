...
void I2cSlaver_DataPacketD1(void)
{
    ...
    // Cell1电压
    t_u16Temp = g_stCellInfoReport.u16VCell[0];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell2电压
    t_u16Temp = g_stCellInfoReport.u16VCell[1];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell3电压
    t_u16Temp = g_stCellInfoReport.u16VCell[2];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell4电压
    t_u16Temp = g_stCellInfoReport.u16VCell[3];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell5电压
    t_u16Temp = g_stCellInfoReport.u16VCell[4];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell6电压
    t_u16Temp = g_stCellInfoReport.u16VCell[5];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell7电压
    t_u16Temp = g_stCellInfoReport.u16VCell[6];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell8电压
    t_u16Temp = g_stCellInfoReport.u16VCell[7];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell9电压
    t_u16Temp = g_stCellInfoReport.u16VCell[8];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell10电压
    t_u16Temp = g_stCellInfoReport.u16VCell[9];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell11电压
    t_u16Temp = g_stCellInfoReport.u16VCell[10];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell12电压
    t_u16Temp = g_stCellInfoReport.u16VCell[11];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell13电压
    t_u16Temp = g_stCellInfoReport.u16VCell[12];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell14电压
    t_u16Temp = g_stCellInfoReport.u16VCell[13];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);

    // Cell15电压
    t_u16Temp = g_stCellInfoReport.u16VCell[14];
    g_u8I2cTxD1Buff[i++] = (UINT8)(t_u16Temp & 0x00FF);
    g_u8I2cTxD1Buff[i++] = (UINT8)((t_u16Temp >> 8) & 0x00FF);
