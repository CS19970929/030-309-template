...
#define  BMS_SOFTWARE_VERDION_DEFAULT   "a009-250901-c092"  //32
...
#define CS_Cur_CHGmax	(20000)
#define CS_Cur_DSGmax	20000
#define CBC_DelayT		1280
#define CBC_Cur_DSG		(50000)
...
#ifdef TERNARYLI
#define OtherElement_default 	{3700,	30,	20,		0,	0,		0,	0,	0,\
