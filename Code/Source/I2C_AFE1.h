...
typedef struct _AFEDATA_{
	...
	UINT16 Cell[16];
	INT16 Cadc;			//����׼�Ŀ��ؼƣ������
	//UINT16 BFLAG;		//����42�����ˣ�������Ϊʱ�����⣬Ҫ�ָ��������һ��Ϊ44��Ҫ����Ϊ4����
}AFEDATA;
...
#if 1
#define TWI_CLK_OUT		{GPIOB->MODER&=0xFFCFFFFF;GPIOB->MODER|=(UINT32)1<<20;}
#define TWI_CLK_IN      {GPIOB->MODER&=0xFFCFFFFF;GPIOB->MODER|=(UINT32)0<<20;GPIOB->PUPDR&=0xFFCFFFFF;GPIOB->PUPDR|=(UINT32)0<<20;}
#define TWI_CLK_HIGH	(PORT_OUT_GPIOB->bit10 = 1)
#define TWI_CLK_LOW	    (PORT_OUT_GPIOB->bit10 = 0)

#define TWI_DAT_OUT		{GPIOB->MODER&=0xFF3FFFFF;GPIOB->MODER|=(UINT32)1<<22;}
#define TWI_DAT_IN      {GPIOB->MODER&=0xFF3FFFFF;GPIOB->MODER|=(UINT32)0<<22;GPIOB->PUPDR&=0xFF3FFFFF;GPIOB->PUPDR|=(UINT32)0<<22;}
#define TWI_DAT_HIGH	(PORT_OUT_GPIOB->bit11 = 1)
#define TWI_DAT_LOW	    (PORT_OUT_GPIOB->bit11 = 0)

#define TWI_RD_CLK		(uint16_t)(GPIOB->IDR&GPIO_Pin_10)  //����SDA 
#define TWI_RD_DAT		(uint16_t)(GPIOB->IDR&GPIO_Pin_11)  //����SDA 
#endif
